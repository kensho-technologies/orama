...
const data = [
  [
    ...
    {date: new Date('2010-04-01'), value: 12, name: 'A'},
    {date: new Date('2010-05-01'), value: 10, name: 'A'},
  ],
  [
    {date: new Date('2010-01-01'), value: 16, name: 'B'},
    {date: new Date('2010-02-01'), value: 13, name: 'B'},
    {date: new Date('2010-03-01'), value: 15, name: 'B'},
    {date: new Date('2010-04-01'), value: 6, name: 'B'},
    {date: new Date('2010-05-01'), value: 14, name: 'B'},
  ],
]
